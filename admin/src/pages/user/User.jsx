...
export default function User() {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      try {
        console.log(`Fetching user from: https://admin-backend-qawz.onrender.com`);
        const res = await axios.get(`https://admin-backend-qawz.onrender.com`);
  ...
  const handleUpdate = async (e) => {
    e.preventDefault();
    try {
      await axios.put(`https://admin-backend-qawz.onrender.com`, updatedUser);
